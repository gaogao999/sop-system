...
- **ISO document control (QP-DC-01 / QP-DC-02)** — a controlled-document workflow on top of the library:
  ...
  - **Electronic approval record** — replaces the physical Approved/Checked/Prepared stamps: each document shows who prepared, checked and approved it, with timestamps, recorded automatically from the authenticated user when they act in the approval queue.
